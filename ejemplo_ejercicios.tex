...
%%
%% \curso{texto}
%%   Aparece en el encabezado de página (centro), en versalitas.
%%   Puede usar \\ para saltos de línea.
%%
\curso{I Ciclo 2026\\MA-1022\\Cálculo para Ciencias Económicas II}

%% \encabezado{texto}
%%   Título del documento, impreso en negrita al inicio con \imprimirtitulo.
%%
\encabezado{Ejercicios Semana N}
