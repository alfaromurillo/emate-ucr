...
\begin{ejercicio}[\ptsguiaej]
  ...
  %%
  \begin{solucion}
    \guia[3]{La matriz aumentada del sistema es}
    \[
      ...
      \end{array}\right).
    \]
    \guia[2]{$R_2 \leftarrow R_2 - 2R_1$:} \guia[2]{$R_3 \leftarrow R_3 - R_1$:}
    \[
      \left(\begin{array}{ccc|r}
        1 & 1 &  1 &  6 \\
        0 & 1 & -1 & -1 \\
    ...
    \[
      ...
      \end{array}\right).
    \]
    \guia[2]{$R_3 \leftarrow \tfrac{1}{3}R_3$:}
    \[
      \left(\begin{array}{ccc|r}
        1 & 1 &  1 &  6 \\
        0 & 1 & -1 & -1 \\
      ...
      \end{array}\right).
    \]
    \guia[2]{$R_2 \leftarrow R_2 + R_3$:} \guia[2]{$R_1 \leftarrow R_1 - R_3$:}
    \[
      \left(\begin{array}{ccc|r}
        1 & 1 & 0 & 3 \\
        0 & 1 & 0 & 2 \\
    ...
    \[
      ...
      \end{array}\right).
    \]
    El conjunto solución es \guia[-1]{$S=\{(x=1, y=2, z=3)\}$} \guia[3]{$S = \{(1,\,2,\,3)\}$}.
  \end{solucion}
\end{ejercicio}
